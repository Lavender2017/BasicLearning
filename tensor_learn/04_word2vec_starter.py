...
from tensor_learn.process_data import process_data
...
def word2vec(batch_gen):
    ...
    embed = tf.nn.embedding_lookup(embed_matrix, center_words, name='embed')#根据center_words 在embed_matrix中查找
    ...
    with tf.Session() as sess:
        ...
        for index in range(NUM_TRAIN_STEPS):
            ...
            loss_batch,_ ,summary= sess.run([loss,optimizer,merge],feed_dict={center_words:centers,target_words:targets})
